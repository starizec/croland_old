...
<div class="container proizvod">
    <div class="row">
        <div class="col-lg-6">
            <h1 class="naziv-proizvoda">Nova narudžba od kupca!</h1>
            <hr>
            <div class="">
          ...
          <div class="col-lg-6">
            <h1 class="naziv-proizvoda mt-40" style="margin-bottom: 20px;">Popis prizvoda</h1>
            ...
            <table class="table">
                ...
                <div class="alert alert-info">
                    <p>
                    <b>Kontaktirajte kupca:</b><br> 
                        • u vezi isporuke naručenih proizvoda<br>
                        • ukoliko niste u mogučnosti poslati naručeni proizvod
                    </p>
                </div>
        </div>
    <hr>
