...
<section class="page-section" id="contact">
  <div class="texture-handler top-mail">
    <div class="texture top-texture-mail"></div>
  </div>
  <div class="container">
    <div class="row">
    ...
    <div class="row">
      <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <input class="form-control" id="name" type="text" placeholder="Ime *" required="required"
              ...
              <div class="form-group">
                <input class="form-control" id="phone" type="tel" placeholder="Broj telefona" required="required"
                  data-validation-required-message="Please enter your phone number.">
                <p class="help-block text-danger"></p>
              </div>
              <div class="form-group">
                <textarea class="form-control" id="message" placeholder="Upit *" required="required"
        ...
        <div style="color: white">
          <p><b>UPIT O STANJU NARUDŽBE ILI O PROIZVODU:</b></p>

          <p>CroLand je portal koji služi kao posrednik između naručitelja i prodavača, te ne sudjeluje u naplati
            i narudžbi proizvoda.</p>

          <p>Molimo Vas da kontaktirate izravno prodavača (proizvođača) u vezi cijene, dostupnosti i stanju
            narudžbe.</p>

          <p> Kontakt informacije prodavača možete saznati klikom na naziv proizvođača koji se nalazi ispod naziva
            proizvoda.</p>

          <p> Za sve nejasnoće molimo vas da nas kontaktirate na info@croland.hr</p>
        </div>
      </div>
    </div>
  </div>
