...
<div class="container proizvod" style="background-color: white; padding-top: 120px;">
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="carousel-inner">
                ...
                @endif
                ">
                    <img style="padding-bottom: 20px;" class="d-block w-100" src="{{ asset('uploads')}}/{{ $slika->slika }}" alt="Third slide">
                </div>
                @endforeach
            </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="proizvod-prodaje">Prodaje: <a href="/{{ $prodaje->id }}">{{ base64_decode($prodaje->naziv) }}</a></div>
            <hr>
                <div class="row">
                    <div class="col-lg-4">
                        <h2 class="cijena-proizvoda">{{ number_format($proizvod->cijena, 2) }} KN <br> <span class="eu-price">{{ number_format($proizvod->cijena / 7.51, 2) }} EUR</span></h2>
                    </div>
    ...
    letter-spacing: 1.2px;">
                            Svi podaci vezani uz artikle prezentirani su u dobroj namjeri. CroLand.hr ne odgovara za eventualne pogreške nastale u opisu proizvoda, greške prilikom štampanja te promjene cijena. Slike artikala su ilustrativne prirode te ne moraju u potpunosti odgovarati artiklima. Za sve eventualne nejasnoće slobodni ste nas kontaktirati na info@croland.hr.
                        </p>
            ...
            <div class="add-to-cart">
                ...
                <button for="addtocart" class="btn btn-success"><i class="fa fa-shopping-cart"></i> Dodaj u košaricu</button>
                        </form>
                ...
                <div class="modal-dialog modal-clhr" role="document">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Kontaktirajte prodavača {{ base64_decode($prodaje->naziv) }}</h5>
                        ...
                        <form id="contactForm" name="sentMessage" novalidate="novalidate">
                            ...
                            <input type="hidden" name="return_path" value="{{ request()->path() }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                    <textarea class="form-control" name="message" id="message" placeholder="Upit *" required="required" data-validation-required-message="Please enter a message." rows="5" required></textarea>
                                    <p class="help-block text-danger"></p>
                                    <button id="sendMessageButton" class="btn btn-info text-uppercase" type="submit">Pošalji</button>
                                    </div>
                                </div>
                                </div>
                            </form>
