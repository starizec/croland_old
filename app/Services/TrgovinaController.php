...
{   
    ...
    public function showProizvod($id){
        ...
        $display_products = $products_ser->DisplayProducts($kategorija[0]->id_kategorije);
    ...
    public function shop($id_kategorije){
        $display_products = new StoreServices();
        $display_products = $display_products->DisplayProducts($id_kategorije);
    ...
    public function order(request $request){
        ...
        return redirect("shop/narudjba-zaprimljena/$order->order_id");
    }
    ...
    public function orderReceived($id){
        ...
        $products_ids = $order[0]->proizvodi_ids;
        $products = $this->getProducts(unserialize($products_ids));

        return view('frontend.order-received')->with('order', $order[0])
